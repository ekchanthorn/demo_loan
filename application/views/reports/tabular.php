...
foreach ($summary_data as $name => $value) {
    ?>
                <li style="color: <?php echo color($i); ?> !important;" class="popover-visits">
                    <div class="left peity_bar_good"><h4><?php echo lang('reports_' . $name); ?></h4></div>
                    <div class="right">
                        <strong style="color: <?php echo color($i); ?> !important;"><?php echo str_replace(' ', '&nbsp;', to_currency($value)); ?></strong>
