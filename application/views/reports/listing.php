			...
			<div class="panel-body">
				<div class="list-group parent-list">
					...
					<?php } ?>
                                        ...
                                        <?php
					if ($this->Employee->has_module_action_permission('reports', 'view_loans', $this->Employee->get_logged_in_employee_info()->person_id))
					{
					?>
						<a href="#" class="list-group-item" id="loans"><i class="fa fa-dollar"></i>	<?php echo lang('reports_loans'); ?></a>
					<?php } ?>
                                        
                                        <?php
					if ($this->Employee->has_module_action_permission('reports', 'view_pawns', $this->Employee->get_logged_in_employee_info()->person_id))
					{
					?>
						<a href="#" class="list-group-item" id="pawns"><i class="fa fa-calendar"></i>	<?php echo lang('reports_pawns'); ?></a>
					<?php } ?>
			...
			<h3 class="page-header text-info">&laquo; <?php echo lang('reports_make_a_selection')?></h3>
				...
				<div class="list-group suppliers hidden">
					...
					<a href="<?php echo site_url('reports/specific_supplier');?>" class="list-group-item"><i class="fa fa-calendar"></i> <?php echo lang('reports_detailed_reports'); ?></a>
                                ...
                                <div class="list-group loans hidden">
					<a href="<?php echo site_url('reports/graphical_summary_loans');?>" class="list-group-item"><i class="fa fa-bar-chart-o"></i> <?php echo lang('reports_graphical_reports'); ?></a>
					<a href="<?php echo site_url('reports/summary_loans');?>" class="list-group-item"><i class="fa fa-building-o"></i> <?php echo lang('reports_summary_reports'); ?></a>
					<a href="<?php echo site_url('reports/detailed_loans');?>" class="list-group-item"><i class="fa fa-calendar"></i> <?php echo lang('reports_detailed_reports'); ?></a>
				</div>
                        
                                <div class="list-group pawns hidden">
					<a href="<?php echo site_url('reports/graphical_summary_pawns');?>" class="list-group-item"><i class="fa fa-bar-chart-o"></i> <?php echo lang('reports_graphical_reports'); ?></a>
					<a href="<?php echo site_url('reports/summary_pawns');?>" class="list-group-item"><i class="fa fa-building-o"></i> <?php echo lang('reports_summary_reports'); ?></a>
					<a href="<?php echo site_url('reports/detailed_pawns');?>" class="list-group-item"><i class="fa fa-calendar"></i> <?php echo lang('reports_detailed_reports'); ?></a>
				</div>
