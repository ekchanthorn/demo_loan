...
foreach($summary_data as $name=>$value) { ?>
	...
	<?php echo "<div class='left peity_bar_good'><h5 style='".color($i)." !important;'>".lang('reports_'.$name). '</h5></div>' ?>
	<?php echo "<div class='right'><strong style='".color($i)." !important;'>".to_currency($value). '</strong></div>' ?>
