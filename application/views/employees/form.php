...
<!--                <div class="form-group">	
                ...
                <div class="form-group">	
                        <?php echo form_label(lang('employees_username') . '* :', 'username', array('class' => 'col-sm-3 col-md-3 col-lg-2 control-label')); ?>
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        <?php
                        echo form_input(array(
                            'name'  => 'username',
                ...
                <div class="form-group">	
                        <?php echo form_label(lang('config_language') . '* :', 'language', array('class' => 'col-sm-3 col-md-3 col-lg-2 col-sm-3 col-md-3 col-lg-2 control-label')); ?>
                    <div class="col-sm-9 col-md-9 col-lg-10">
                        <?php
...
?>
                ...
                <script type='text/javascript'>
                    ...
                    {
                    $.post('<?php echo site_url("employees/check_duplicate"); ?>', {term: $('#identity_no').val()}, function(data) {
