...
<div id="content-header" class="hidden-print">
        <h1> <i class="icon fa fa-<?php if($controller_name=="customers"){
                echo 'group';
            }else if($controller_name=="loans"){
                echo "dollar";
            }else{
                echo "user";
            } ?>"></i>
	...
	<div class=" pull-right">
		<div class="row">
			<div class="col-md-12 center" style="text-align: center;">					
				...
				?>
                                <?php if($controller_name != 'loans' && $controller_name != 'pawns'){?>
				...
				<?php if ($controller_name =='customers' || $controller_name == 'suppliers') {  
					...
					<?php
					if ($controller_name == 'customers' || $controller_name == 'employees' || $controller_name == 'suppliers'|| $controller_name == 'loans' || $controller_name == 'pawns') {	
					...
					?>
                                        <?php 
                                            if($controller_name == 'loans'){
                                                echo anchor("$controller_name/setting",
							'<i title="'.lang('loans_setting').'" class="fa fa-cog tip-bottom hidden-lg fa fa-2x"></i><span class="visible-lg">'.lang('loans_setting').'</span>',
							array('class'=>'btn hidden-xs btn-primary','title'=>lang('loans_setting')));
                                            }
                                        ?>
