...
class Expenses extends Person_controller
{
	...
	{
            $params = $this->session->userdata('expenses_search_data') ? $this->session->userdata('expenses_search_data') : array('offset' => 0, 'order_col' => 'loan_id', 'order_dir' => 'desc', 'search' => FALSE);
