...
class Employees extends Person_controller
{
	...
	function excel_export() {
		...
		$rows = array();
		$row = array(lang('common_first_name'),lang('common_last_name'),lang('common_gender'),lang('common_dob'),lang('common_identity_no'),lang('common_age'), lang('common_email'),lang('common_phone_number'),lang('common_address'),lang('common_comments'));
		$rows[] = $row;
		foreach ($data as $r) {
			$row = array(
				$r->first_name,
