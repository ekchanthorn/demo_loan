...
function color($i){
	$col = array('#2196F3','#6A1B9A','#4CAF50','#F57F17','#FF5722','#795548','#827717','#00BFA5','#33691E','#FF9800');
        return $col[$i];
}

function date_distant($previous,$current_date){
    $datetime1 = date_create($previous);
    $datetime2 = date_create($current_date);
    $interval = date_diff($datetime1, $datetime2);
    return $interval->format('%a').' '.lang('common_day');
}
